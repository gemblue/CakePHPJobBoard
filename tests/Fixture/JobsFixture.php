...
class JobsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'posted_by' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'posted_by' => 1,
                'company_id' => 1,
                'created_at' => '2020-05-23 06:20:38',
                'updated_at' => '2020-05-23 06:20:38',
            ],
        ];
        parent::init();
    }
